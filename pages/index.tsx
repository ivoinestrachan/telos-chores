...
const index: NextPage = () => {
  ...
  const choreSchedule: ChoreSchedule[] = [
    ...
    },
    {
      ...
      priority: "normal",
      category: "trash",
      monday: { name: "ALI", time: "" },
      wednesday: { name: "WILLIAM", time: "" },
      friday: { name: "AXEL", time: "" },
      sunday: { name: "RAPHA", time: "" },
    },
    {
      task: "SWEEP THE FLOOR",
      priority: "normal",
      category: "sweep",
      tuesday: { name: "NATTY", time: "" },
      thursday: { name: "ARISSTLE", time: "" },
      saturday: { name: "DAMIAN", time: "" },
    },
    {
      task: "CLEAN TOILETS / BATHROOM",
      priority: "high",
      category: "bathroom",
      wednesday: { name: "HEYE", time: "" },
      saturday: { name: "ALI", time: "" },
    },
    {
      task: "WIPE COUNTERS / TV",
      priority: "normal",
      category: "counters",
      monday: { name: "PANOS", time: "" },
      wednesday: { name: "IVOINE", time: "" },
      friday: { name: "WILLIAM", time: "" },
      sunday: { name: "BRIT", time: "" },
    },
    {
      task: "ORGANIZE SHOE RACK",
      priority: "normal",
      category: "shoes",
      tuesday: { name: "AXEL", time: "" },
      thursday: { name: "RAPHA", time: "" },
      saturday: { name: "NATTY", time: "" },
    },
    {
      task: "ORGANIZE LIVING ROOM",
      priority: "normal",
      category: "living",
      monday: { name: "HEYE", time: "" },
      wednesday: { name: "BRIT", time: "" },
      friday: { name: "DAMIAN", time: "" },
      sunday: { name: "ARISSTLE", time: "" },
    },
    {
      task: "RERACK DISHES",
      priority: "normal",
    ...
    },
    {
      ...
      priority: "normal",
      category: "table",
      monday: { name: "RAPHA", time: "" },
      tuesday: { name: "PANOS", time: "" },
      wednesday: { name: "ALI", time: "" },
      thursday: { name: "BRIT", time: "" },
      friday: { name: "IVOINE", time: "" },
      saturday: { name: "WILLIAM", time: "" },
      sunday: { name: "AXEL", time: "" },
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="bg-blue-600 text-white p-6 rounded-t-lg shadow">
          <h1 className="text-2xl font-bold text-center">
            Telos Chore Schedule
          </h1>
        </header>

        <div className="text-red-600 text-center mt-5 text-5xl">
          YOU WILL BE TASED IF TASK IS NOT COMPLETED
        </div>
                    ...
                    <tr key={index}>
                      ...
                      <td className={getDayCellClass(chore, "wednesday")}>
                        {chore.wednesday && (
                          <>
                            <div className="font-medium">
                              {chore.wednesday.name}
                            </div>
                            <div className="text-sm text-gray-600">
                              {chore.wednesday.time}
                            </div>
